...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            int countSymbolsInLine = Integer.parseInt(search.getText().toString().trim()); // считывание введённого текста

            mapPoem = stringMapPoem(poem); // формирование мап подстрок поэмы

            String resultSearch = searchMapPoem(countSymbolsInLine, mapPoem); // поиск String searchText в мап
    ...
    private String searchMapPoem(Integer size, Map<Integer, String> map) {

        String result = "";
        int count = 0;

        for (Integer key: map.keySet()) { // перебор мап по ключам
            if(Objects.requireNonNull(map.get(key)).length() == size) { // если в строке с ключом key имеется фраза поиска, то
